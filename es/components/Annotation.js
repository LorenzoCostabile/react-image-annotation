...
var Target = Items;
export default compose(isMouseHovering(), withRelativeMousePos())((_class = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }), /*#__PURE__*/React.createElement(Items, null, props.annotations.map(function (annotation) {
  ...
  allowTouch: T.bool
}), _defineProperty(_class, "defaultProps", defaultProps), _class));